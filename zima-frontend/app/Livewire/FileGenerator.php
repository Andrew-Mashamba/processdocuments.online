...
class FileGenerator extends Component
{
    ...
    {
        // Use Gateway URL from config (defaults to localhost:18790)
        $this->apiUrl = config('services.gateway.url', 'http://localhost:18790');
    ...
    public function getStreamingUrl(): string
    {
        ...
        // Gateway handles both agent and standard modes on the same endpoint
        return "{$this->apiUrl}/api/chat/stream";
    }
